...
public class LogController extends BaseController {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.winds.bm.controller.system.LogController.class);
    ...
    public Result delete(@RequestParam("ids[]") List<Long> ids){
        if(ids == null || ids.size()==0){
            return Result.error(ResultCode.PARAM_IS_BLANK,"id不能为空");
        }
