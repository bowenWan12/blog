//package com.winds.bm.common.exception;
//
//
...
//                                                              Exception e){
////        Result restResponse = Result.error(ResultCode.ERROR, e.getMessage());
//        Map restResponse = new HashMap<>();
//        restResponse.put("code", ResultCode.ERROR);
//        restResponse.put("massage", e.getMessage());
...
//                Result failResponse = Result.error(ResultCode.PERMISSION_NO_ACCESS,"您无此权限,请联系管理员!");
...
//            }
//        }else {
////            Result restResponse = Result.error(ResultCode.ERROR, unauthorizedException.getMessage());
//            Map restResponse = new HashMap<>();
//            restResponse.put("code", ResultCode.ERROR);
//            restResponse.put("massage", unauthorizedException.getMessage());
//            return new ModelAndView("admin/error/500",restResponse);
//        }
//
//        return null;
...
//            return "admin/error/404";
//        }else{
//            Result restResponse = Result.error(ResultCode.ERROR, ex.getMessage());
